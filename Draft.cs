...
{
    {
        ...
        Console.WriteLine("Le jeu a bien été généré il comporte " + Dex.Count + " cartes. Retour au menu ==>");
        Console.WriteLine(" ");
...
static void GenererExcuse()
{
    ...
    Dex.Add(excuse);
    Console.WriteLine("Le jeu a bien été généré il comporte maintenant " + Dex.Count + " cartes. Retour au menu ==>");
    Menu();
}
